    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $edit = "<a href='" . route('admin.blog-category.edit', $query->id) . "' class='btn edit-btn-primary'><i
                class='fas fa-edit'></i></a>";
                $delete = "<a href='" . route('admin.blog-category.destroy', $query->id) . "' class='btn btn-danger
